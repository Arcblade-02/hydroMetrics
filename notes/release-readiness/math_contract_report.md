...
br2||Bias-corrected R-squared computed as abs(slope(sim ~ obs)) * cor(sim, obs)^2.||Krause, P., Boyle, D. P., & Baese, F. (2005). Comparison of different efficiency criteria for hydrological model assessment.
```
